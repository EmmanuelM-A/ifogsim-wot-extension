...
public class CustomControllerTwo extends SimEntity{
    ...
    public CustomControllerTwo(String name, List<FogDevice> fogDevices, List<Sensor> sensors, List<Actuator> actuators) {
        super(name);
